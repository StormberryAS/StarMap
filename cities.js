// Worldwide city catalogue: { name, country, lat, lon, tz }.
// Bundled locally and imported as an ES module — no external/network calls, so StarMap
// stays offline-capable and privacy-first. Ported verbatim from the Stormberry SunApp
// catalogue; StarMap uses name/country/lat/lon (tz is retained but unused here).
export const CITIES = [
